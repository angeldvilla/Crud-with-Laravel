...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-8">
        ...
        <form action="#" method="POST">
            ...
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg text-lg">Iniciar Sesión</button>
            <p class="mt-4 text-center text-gray-600">¿No tienes una cuenta? <a href="/registro" class="text-blue-600 hover:text-blue-500">Regístrate aquí</a></p>
        </form>
    </div>
</body>
