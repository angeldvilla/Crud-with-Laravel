        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="dark:bg-gray-700 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                <form action="{{ route('clientes.store') }}" method="POST" class="max-w-sm mx-auto">
                    ...
                    <input type="hidden" name="id_rol" id="id_rol" value=3 class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
